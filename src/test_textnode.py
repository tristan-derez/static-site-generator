...
class TestTextNode(unittest.TestCase):
    ...
    def test_not_eq_none_url(self):
        node_with_url = TextNode("This is a text node", "bold", url="https://example.com")
    ...
    def test_eq_same_url(self):
        node_with_url1 = TextNode("This is a text node", "bold", url="https://example.com")
        node_with_url2 = TextNode("This is a text node", "bold", url="https://example.com")
